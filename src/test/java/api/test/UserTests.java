...
public class UserTests {
	...
	public void testPostUser() {
		...
		Response postUserRes=UserEndPoints.createUser(userPayload);
	...
	public void testGetUser() {
		...
		Response getUserRes = UserEndPoints.getUser(this.userPayload.getUsername());
	...
	public void testUpdateUser() {
		...
		Response postUserRes=UserEndPoints.updateUser(this.userPayload.getUsername(), userPayload);
		postUserRes.then().statusCode(200).log().all();		
		Assert.assertEquals(postUserRes.statusCode(), 200);
		
		Response getUserPostUpdateRes = UserEndPoints.getUser(this.userPayload.getUsername());
	...
	public void testDeleteUser() {
		...
		Response getUserRes = UserEndPoints.deleteUser(this.userPayload.getUsername());
		Assert.assertEquals(getUserRes.statusCode(), 200);
		getUserRes.then().log().all();
